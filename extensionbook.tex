...
\usepackage{url}
\usepackage{marvosym}
\lstset{breaklines=true, prebreak={\Righttorque}}
...
Der Extension kann eine Erläuterung Ihrer Funktionsweise über das \linebreak<extension-description>-Tag hinzugefügt werden, wobei es mehrere Lokalisierungen dieser Beschreibung aufnehmen kann.
